...
written_questions <- fromJSON('https://questions-statements-api.parliament.uk/api/writtenquestions/questions?tabledWhenFrom=2022-01-01&tabledWhenTo=2022-12-31&answered=Any&questionStatus=AllQuestions&includeWithdrawn=true&expandMember=true&answeringBodies=17&answeringBodies=14&answeringBodies=214&answeringBodies=202&answeringBodies=29&house=Commons')

written_questions$results

written_questions_get <- GET('https://questions-statements-api.parliament.uk/api/writtenquestions/questions?tabledWhenFrom=2022-01-01&tabledWhenTo=2022-12-31&answered=Any&questionStatus=AllQuestions&includeWithdrawn=true&expandMember=true&answeringBodies=17&answeringBodies=14&answeringBodies=214&answeringBodies=202&answeringBodies=29&house=Commons')


written_questions_parsed <- content(written_questions_get, "parsed")

str(written_questions_parsed$results)

written_questions_tibble <- do.call(rbind, lapply(written_questions_parsed$results, as_tibble, stringsAsFactors = FALSE))



written_questions_tibble %>% 
