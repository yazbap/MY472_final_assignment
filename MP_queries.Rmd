...
results_list <- append(results_list, written_data$results)
...
for (i in seq_along(results_list)){ 
  # Create a new row
  new_row <- tibble(
    question_id = results_list[[i]]$value$id,
    asking_member_id = results_list[[i]]$value$askingMember$id,  
    asking_member_name = results_list[[i]]$value$askingMember$name,
    asking_member_party = results_list[[i]]$value$askingMember$party,
    asking_member_from = results_list[[i]]$value$askingMember$memberFrom,
    answering_body_name = results_list[[i]]$value$answeringBodyName
  )
